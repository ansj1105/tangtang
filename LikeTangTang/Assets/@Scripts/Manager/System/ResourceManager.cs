...
public class ResourceManager
{
    ...
    public async UniTask<int> CountGroupAsync<T>(string _label) where T : Object
    {
        ...
        {
            Debug.LogError($"LoadResourceLocationsAsync 카운트 실패 : {_label} ({typeof(T).Name}). : {e.Message}");
            return 0;
        }
        finally
        {
